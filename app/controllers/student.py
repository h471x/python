...
def student_insert_template():
    return student.insert(student_data_template)
...
def student_update(student_data, student_new_data):
    return student.update(student_data, student_new_data)

def student_delete(student_data):
    return student.delete(student_data)

def student_delete_all():
    return student.delete_all()
